...
!(function () {
  ...
  const Yn = (e, t, n) => {
    ...
    Eo = (e, t, n, o) =>
      ((e, t, n, o, r) => {
        ...
        return (
          e.dom.addEventListener(t, s, false),
  ...
  const Fo = (e) => (t) => !!t && t.nodeType === e,
    ...
    Mr = (e) => (
      Lr(e) && (e = e.parentNode),
      Pr(e) && e.hasAttribute("data-mce-caret")
    ),
    Ir = (e) => Lr(e) && Br(e.data),
    Fr = (e) => Mr(e) || Ir(e),
    ...
    zr = (e) => {
      ...
      return (
        !!Yo(t) &&
        (t.data.charAt(e.offset()) === Tr ||
          (e.isAtStart() && Ir(t.previousSibling)))
      );
    },
    jr = (e) => {
      const t = e.container();
      return (
        !!Yo(t) &&
        (t.data.charAt(e.offset() - 1) === Tr ||
          (e.isAtEnd() && Ir(t.nextSibling)))
      );
    },
    ...
    Zr = Fr,
    es = (e) =>
      !Zr(e) && (Yr(e) ? !Xr(e.parentNode) : Qr(e) || Gr(e) || Jr(e) || ts(e)),
    ts = (e) =>
      !((e) => zo(e) && "true" === e.getAttribute("unselectable"))(e) && Kr(e),
    ns = (e, t) =>
      es(e) &&
      ((e, t) => {
    ...
    cs =
      ("data-mce-bogus",
      "all",
      (e) => zo(e) && "all" === e.getAttribute("data-mce-bogus"));
  const us = (e, t = !0) =>
      ((e, t) => {
        let n = 0;
        if (is(e, e)) return !1;
    ...
    bs = (e, t, n) => {
      ...
      q(wo(n), (t) => {
        Yn(t, s, a).each((n) => {
          const o = ((t, o) =>
            G(Pn(t), (t) => s(t) && !e.isValidChild(jt(n), jt(t))))(t);
          if (o.length > 0) {
            const t = Rn(n);
            (q(o, (e) => {
              Yn(e, s, a).each((t) => {
    ...
    aa = (e = {}) => {
      ...
      (e.valid_elements
        ...
        : (Js(d, (e, t) => {
          ...
          Js(
            na("p h1 h2 h3 h4 h5 h6 th td pre div address caption li"),
            (e) => {
              n[e].paddEmpty = !0;
            },
          ),
        ...
        if (t) {
          ...
          for (; s--; ) {
            ...
            if (a) {
              ...
              (n && 0 !== a.length) ||
                (delete r[t],
                fa(e, a.fakeName || t, a.nativeHandler, a.capture));
            }
          }
        } else
          (ge(r, (t, n) => {
    ...
    _a = (e, t = {}) => {
      ...
      const a = Os.forElement(bn(e), {
                ...
                C(n)
                  ...
                  : ((e, t) => {
                      const n = rn(e)
                        ...
                        : ((e, t) => (H(sn(e), t) ? ln(e, t) : an(e, t)))(e, t);
                      cn(e);
                    })(o, e);
              });
            }
        ...
        G = {
          ...
          events: c,
          isBlock: (e) =>
            m(e) ? ke(u, e) : zo(e) && (ke(u, e.nodeName) || ks(l, e)),
          root: null,
    ...
    Pa = () => {
      const e = [],
        ...
        a = (e, n) => {
          ...
          !o ||
            (n && -1 === ("," + (n || "") + ",").indexOf("," + o + ",")) ||
            Ra.ScriptLoader.add(t[e] + "/langs/" + o + ".js");
        },
        i = (e, t = "added") =>
  ...
  const La = (e) => {
    ...
    Ka = (e, t) =>
      en(e, "data-mce-bogus") || Mo(e, '[data-mce-bogus="all"]', qa(t)),
    Ga = (e, t) => {
  ...
  const Qa = (e) => {
    ...
    ti = (e, t, n = L) => {
      ...
      return {
        current: () => I.from(o.current()).filter(Yo),
        next: () => r("next"),
        prev: () => r("prev"),
        prev2: () => r("prev2"),
      };
    ...
    li = (e, t) =>
      e.top > t.bottom || (!(e.bottom < t.top) && ai(t.bottom - e.top, e, t)),
    di = (e, t, n) => {
        ...
        n ||
          (n = ((e) => {
            ...
            if (gi(r))
              if (e.isAtEnd()) {
                const e = ki(r, s);
                (Ci(e) && o(e, e.data.length),
                  vi(e) && !wi(e) && n(Oi(Ai(e), !1)));
              } else {
                const a = ki(r, s);
                if ((Ci(a) && o(a, 0), vi(a) && e.isAtEnd()))
                  return (n(Oi(Ai(a), !1)), t);
  ...
  ((Ti.fromRangeStart = (e) => Ti(e.startContainer, e.startOffset)),
    ...
    (Ti.isAbove = (e, t) =>
      Lt(le(t.getClientRects()), de(e.getClientRects()), ii).getOr(!1)),
    (Ti.isBelow = (e, t) =>
      Lt(de(t.getClientRects()), le(e.getClientRects()), li).getOr(!1)),
  ...
  const Bi = (e, t) => {
    ...
    Di = (e, t, n) => {
      er(n)
        ? ((e, t, n) => {
            ...
            (t.insertNode(n),
              o.each((t) => Bi(e, t.previousSibling)),
              r.each((t) => Bi(e, t.nextSibling)));
          })(e, t, n)
        : ((e, t, n) => {
    ...
    Fi = (e) =>
      e
        ? Te(
            e.childNodes,
            (e, t) => (
              Li(t) && "BR" !== t.nodeName ? (e = e.concat(Fi(t))) : e.push(t),
              e
            ),
            [],
          )
    ...
    Yi = (e, t, n) => {
      ...
      const s = ((e) =>
        Gi(e.startContainer, e.startOffset) || Gi(e.endContainer, e.endOffset))(
        r,
      );
      if (s) {
        const e = s.tagName;
      ...
      return ((e, t, n, o) => {
        ...
        return t.isCollapsed()
          ? { start: s, forward: a, ...i }
          : { start: s, end: Vi(r, e, n, o, !1), forward: a, ...i };
      })(e, n, t, r);
    },
    Xi = (e, t, n) => {
      const o = {
      ...
      Ti.isTextPosition(t)
        ...
        : ((e, t) =>
            t.container() === e.parentNode
              ...
              : sc(e, t))(e, t),
    ic = (e) => {
      (ec(e) && Fr(e) && (Ur(e) ? e.removeAttribute("data-mce-caret") : nc(e)),
        tc(e) && (rc(e), 0 === e.data.length && nc(e)));
    },
    lc = rr,
    dc = ir,
    cc = sr,
  ...
  const Vc = rr,
    ...
    Yc = (e) =>
      ...
      ((e) =>
        !!ts(e) &&
        !X(ce(e.getElementsByTagName("*")), (e, t) => e || Wr(t), !1))(e),
    Xc = ns,
    Qc = (e, t) =>
      e.hasChildNodes() && t < e.childNodes.length ? e.childNodes[t] : null,
    Jc = (e, t) => {
      if (Sc(e)) {
        if (Gc(t.previousSibling) && !qc(t.previousSibling))
          return Ti.before(t);
    ...
    Zc = (e, t, n) => {
      ...
      if (t.isEqual(Ti.after(n)) && n.lastChild) {
        if (
          ((a = Ti.after(n.lastChild)),
          _c(e) && Gc(n.lastChild) && Wc(n.lastChild))
        )
          return Kc(n.lastChild) ? Ti.before(n.lastChild) : a;
      } else a = t;
      const i = a.container();
      let l = a.offset();
      if (qc(i)) {
      ...
      if (
        o &&
        ((Sc(e) && a.isAtEnd()) || (_c(e) && a.isAtStart())) &&
        ((o = Rc(o, e, M, n, !0)), Xc(o, n))
      )
        return Jc(e, o);
      r = o ? Rc(o, e, Xc, n) : o;
      const d = De(
      ...
      return !d || (r && d.contains(r))
        ? r
          ? Jc(e, r)
          : null
        : ((a = Sc(e) ? Ti.after(d) : Ti.before(d)), a);
    },
    eu = (e) => ({
      next: (t) => Zc($c.Forwards, t, e),
      prev: (t) => Zc($c.Backwards, t, e),
    }),
    ...
    su = (e, t, n) =>
      ru(e, t, n).bind((o) =>
        ...
        ((e, t, n) => {
          return e
            ? !ou(t, n) &&
                ((o = t), !(!Ti.isTextPosition(o) && tr(o.getNode()))) &&
                nu(t) &&
                tu(n)
            : !ou(n, t) && tu(t) && nu(n);
          var o;
    ...
    au = (e, t, n, o) =>
      su(e, t, n).bind((n) => (o(n) ? au(e, t, n, o) : I.some(n))),
    iu = (e, t) => {
      ...
      return Yo(n)
        ...
        : n
          ? es(n)
            ? I.some(
                e ? Ti.before(n) : tr((o = n)) ? Ti.before(o) : Ti.after(o),
              )
            : ((e, t, n) => {
      ...
      ((e, t) => {
        ...
        if (t) {
          if (hu(t))
            return ((e, t) => {
              const n = e.createRng();
              return wu(e, !0, t, n) && wu(e, !1, t, n)
                ? I.some({ range: n, forward: bu(t) })
                : I.none();
            })(n, t);
          if (((e) => m(e.start))(t))
            return ((e, t) => {
          ...
          if (((e) => ke(e, "id"))(t))
            return ((e, t) => {
              ...
              return Lt(n, o.or(n), (n, o) => {
                const r = e.createRng();
                return (
                  r.setStart(vu(e, n.container()), n.offset()),
                  r.setEnd(vu(e, o.container()), o.offset()),
                  { range: r, forward: bu(t) }
                );
              });
            })(n, t);
          ...
          if (((e) => ke(e, "rng"))(t))
            return I.some({ range: t.rng, forward: bu(t) });
        }
        return I.none();
  ...
  const Ru = (e) => "" !== e && -1 !== " \f\n\r\t\v".indexOf(e),
        ...
        ((e) => {
          ...
          return Yo(t)
            ? n === t.data.length
              ? I.some(bn(t))
              : I.none()
            : I.from(t.childNodes[n - 1]).map(bn);
        })(t),
        (t, n) => {
    ...
    Vu = (e, t, n, o) => {
      ...
      let i = n;
      do {
        if (Yo(i) && 0 !== Dt.trim(i.data).length)
    ...
    Qu = (e, t, n) => {
      ...
      (Ku(o, !0, () => {
        ...
        a && rr(s) && r.isChildOf(s, e.getBody())
    ...
    ym = (e, t) => {
      let n = t;
      for (; n; ) {
        if (zo(n) && e.getContentEditable(n))
        ...
        l = (t, n, o) => {
          ...
          return I.from(
            l(
              t,
              n,
              (e, t) => (pm(e.parentNode) ? -1 : ((a = e), o(r, e, t))),
              i,
            ),
          );
        };
    ...
    Sm = (e, t, n, o) => {
      ...
      if (
        (s && um(i) && i.wrapper && (s = hm(e, s, "ul,ol").reverse()[0] || s),
        !s)
      )
        for (
          s = n;
          s && s[o] && !e.isBlock(s[o]) && ((s = s[o]), !sm(s, "br"));
    ...
    _m = (e, t, n, o) => {
      ...
      return (
        !C(n[o]) && (!(r !== t && !y(r) && !e.isBlock(r)) || _m(e, t, r, o))
      );
    },
    Nm = (e, t, n, o, r) => {
      let s = n;
    ...
    Am = (e, t, n, o = !1) => {
      ...
      return (
        ...
        zo(a) &&
          a.hasChildNodes() &&
          ((a = ui(a, t.collapsed ? i : i - 1)), Yo(a) && (i = a.data.length)),
        (r = ym(e, r)),
        (a = ym(e, a)),
        Rm(r) &&
        ...
        t.collapsed &&
          (km(e, e.getRoot(), r, s, !0, o).each(
            ({ container: e, offset: t }) => {
              ((r = e), (s = t));
            },
          ),
          km(e, e.getRoot(), a, i, !1, o).each(
            ({ container: e, offset: t }) => {
              ((a = e), (i = t));
            },
          )),
        (fm(l) || l.block_expand) &&
          ((fm(l) && Yo(r) && 0 !== s) || (r = Nm(e, n, r, s, !0)),
          (fm(l) && Yo(a) && i !== a.data.length) || (a = Nm(e, n, a, i, !1))),
        gm(l) &&
          ((r = Em(e, n, t, r, "previousSibling")),
          (a = Em(e, n, t, a, "nextSibling"))),
        (um(l) || mm(l)) &&
          ((r = Sm(e, n, r, "previousSibling")),
          (a = Sm(e, n, a, "nextSibling")),
          um(l) &&
            (e.isBlock(r) || (r = Nm(e, n, r, s, !0)),
            e.isBlock(a) || (a = Nm(e, n, a, i, !1)))),
  ...
  const Im = (e, t, n) =>
    ...
    Vm = {
      ...
      HOME: 36,
      modifierPressed: (e) =>
        e.shiftKey || e.ctrlKey || e.altKey || Vm.metaKeyPressed(e),
      metaKeyPressed: (e) =>
        ...
        L = (o) => {
          ...
          if (
            ...
            if (P(t, a) && P(e.getEnd(!0), a))
              return (n.setAttrib(a, qm, i), void B.throttle(a));
          }
          D();
        },
        M = () => {
    ...
    Zm = (e, t, n) =>
      t(bn(n.startContainer), n.startOffset, bn(n.endContainer), n.endOffset);
  (Jm.ltr, Jm.rtl);
  const ef = (e, t, n, o) => ({ start: e, soffset: t, finish: n, foffset: o }),
      ...
      return ((e, t) => {
        const n = ((e, t) =>
          t.match({
            ...
            relative: (t, n) => ({
              ltr: Pe(() => Xm(e, t, n)),
              rtl: Pe(() => I.some(Xm(e, n, t))),
            }),
            exact: (t, n, o, r) => ({
              ltr: Pe(() => Qm(e, t, n, o, r)),
              rtl: Pe(() => I.some(Qm(e, o, r, t, n))),
            }),
          }))(e, t);
        return ((e, t) => {
          const n = t.ltr();
    ...
    vf = (e, t, n, o, r) => {
      ...
      const u = new Io(r, c);
      for (; (d = u[o ? "prev" : "next"]()); ) {
        if ("false" === e.getContentEditableParent(d) || hf(d, s))
          return I.none();
        if (Yo(d) && d.data.length > 0)
          return pf(d, s, "A")
            ? I.none()
            : I.some(Ti(d, o ? d.data.length : 0));
    ...
    yf = (e, t, n, o) => {
      ...
      if (
        (zo(i) && l > i.childNodes.length - 1 && (u = !1),
        Zo(i) && ((i = r), (l = 0)),
        i === r)
      ) {
    ...
    xf = (e) => {
      ...
      if (t === o && Yo(t)) {
        ...
        (Yo(t) && n > 0 && n < t.data.length && ((t = wf(t, n)), (n = 0)),
        Yo(o) && r > 0 && r < o.data.length)
      ) {
        const e = wf(o, r).previousSibling;
        ((o = e), (r = e.data.length));
      }
  ...
  ((kf.compareRanges = ff),
    (kf.getCaretRangeFromPoint = mf),
    (kf.getSelectedNode = ci),
    (kf.getNode = ui));
  const Ef = ((e, t) => {
      const n = (t) => {
          const n = ((e) => {
  ...
  const Rf = (e) => "textarea" === jt(e),
    ...
    Ff = (e, t, n, o) => {
      ...
      s.top < a.y
        ? To(n.element, !1 !== o)
        : s.top > a.bottom && To(n.element, !0 === o);
    },
    ...
    Gf = (e) =>
      sf.range(
        e.start,
        Kf(e.soffset, e.start),
        e.finish,
        Kf(e.foffset, e.finish),
      ),
  ...
  const rg = _a.DOM,
    ...
    ag = (e, t) => {
      const n = cd(e),
        o = rg.getParent(
          t,
          (t) =>
            ((e) => zo(e) && tg.isEditorUIElement(e))(t) ||
            (!!n && e.dom.is(t, n)),
        );
      return null !== o;
    },
    ...
    dg = (e, t) => {
      (e.focusedEditor === t.editor && (e.focusedEditor = null),
        !e.activeEditor &&
          og &&
          (rg.unbind(document, "focusin", og), (og = null)));
    },
    cg = (e, t) => {
      ((e, t) =>
        ((e) =>
          e.collapsed
            ? I.from(ui(e.startContainer, e.startOffset)).map(bn)
            : I.none())(t).bind((t) =>
      ...
      e.inline
        ? ((e) => {
            ...
            return (
              ...
              qf(n) ||
                ((o = n),
                Wf(Hn(o)).filter((e) => o.dom.contains(e.dom))).isSome())
            );
            var n, o;
          })(e)
    ...
    Cg = (e) => {
      ...
      return (
        ...
        ((e) => {
          return (
            Vt((t = e)) && zt(t.dom) && "false" === Jt(e, "contenteditable")
          );
          var t;
        })(e)
      );
  ...
  const zg = ["font", "text-decoration", "text-emphasis"],
    ...
    Wg = (e) => {
      ...
      return (
        Yo(t) &&
        (0 === t.data.length || (Br(t.data) && Mm.isBookmarkNode(t.parentNode)))
      );
    },
    Kg = (e, t) => (n) =>
      Tc(e ? 0 : -1, n)
    ...
    Yg = (e) =>
      rr(e) && !((e) => zo(e) && "all" === e.getAttribute("data-mce-bogus"))(e),
    Xg = Kg(!0, Gg),
    Qg = Kg(!1, Gg),
    Jg = Kg(!0, ir),
    Zg = Kg(!1, ir),
    ...
    rp = (e, t) =>
      ((e, t, n) =>
        kn(t, e) ? An(e, (e) => n(e) || xn(e, t)).slice(0, -1) : [])(e, t, L),
    ...
    bp = (e, t) =>
      ((e) => I.from(e.getNode(!0)).map(bn))(t).exists(yr) ||
      pp(!1, e, t).isSome(),
    vp = O(pp, !1),
    yp = O(pp, !0),
    ...
    Ep = (e) =>
      zc(e)
        .bind((e) => Xn(e, Vt))
        .exists((e) =>
          ((e) => H(["pre", "pre-wrap"], e))(ao(e, "white-space")),
        ),
    Sp = (e, t) => (n) => {
    ...
    Bp = (e, t, n) => {
      ...
      return n || !Ap(o, o.length - 1) || Rp(e, r)
        ? !!(n && Op(o, o.length - 1) && Np(e, r)) &&
            ((t.data = o.slice(0, -1) + cr), !0)
    ...
    Up = (e) => {
      return es(e.previousSibling)
        ? I.some(
            ((t = e.previousSibling),
            Yo(t) ? Ti(t, t.data.length) : Ti.after(t)),
          )
        : e.previousSibling
        ...
        e
          ? ((e, t) =>
              zp(t)
                ...
                .orThunk(() =>
                  ((e, t) =>
                    lu(e, Ti.after(t)).orThunk(() => du(e, Ti.before(t))))(
                    e,
                    t,
                  ),
                ))(t, n)
      ...
      const i = ((e, t, n) => {
        ...
        return (
          ...
          s.isSome() && a.isSome() && i.isSome()
            ...
            () => (
              n &&
                (o.each((e) => Mp(e.dom, e.dom.length)),
                r.each((e) => Lp(e.dom, 0))),
              t
            ),
          )
    ...
    Gp = (e, t, n) => {
      const o = ((e, t, n) => G(_a.DOM.getParents(n.container(), "*", t), e))(
        e,
        t,
        n,
      );
    ...
    oh = (e) => {
      var t;
      return (8 === Ht((t = e)) || "#comment" === jt(t) ? On(e) : In(e))
        .bind(oh)
        .orThunk(() => I.some(e));
    },
    rh = (e, t, n, o = !0) => {
      ...
      if (
        (a.dom === e.getBody()
          ? nh(e, o)
          : us(a) && (Ar(a), o && e.selection.setCursorLocation(a.dom, 0)),
        !xn(n, a))
      ) {
        const e = Pt(Nn(a), n)
          ? []
    ...
    ch = (e, t) =>
      zu(e.start, t).bind((n) => zu(e.end, t).bind((e) => Mt(xn(n, e), n))),
    uh = (e) => (t) =>
      ch(t, e).map((e) =>
        ((e, t, n) => ({ rng: e, table: t, cells: n }))(t, e, sh(e)),
      ),
    mh = (e, t, n, o) => {
    ...
    fh = (e, t) => Z(e, (e) => xn(e, t)),
    gh = (e) =>
      Lt(fh(e.cells, e.rng.start), fh(e.cells, e.rng.end), (t, n) =>
        e.cells.slice(t, n + 1),
      ),
    ph = (e, t) => {
              ...
              mh(e, t, n, o)
                ...
                .bind((e) => {
                  ...
                  if (o && e.cells.length === r.length)
                    return I.some(ih.fullTable(e.table));
                  if (r.length > 0) {
                    if (o) return I.some(ih.partialTable(r, I.none()));
                    {
                      const e = ph(n, t);
                      return I.some(
                        ih.partialTable(r, I.some({ ...t, rng: e })),
                      );
                    }
                  }
                  return I.none();
        ...
        const o = e.selection.getRng(),
          r = n
            .bind(({ rng: n, isStartInTable: r }) => {
              const s = ((e, t) =>
                I.from(e.dom.getParent(t, e.dom.isBlock)).map(bn))(
                e,
              ...
              (n.deleteContents(),
                ((e, t, n) => {
                  n.each((n) => {
                    t
                      ? yo(n)
                      : (Ar(n), e.selection.setCursorLocation(n.dom, 0));
                  });
                })(e, r, s.filter(us)));
              const a = r ? t[0] : t[t.length - 1];
              return (
                vh(e, a, o, r),
                us(a) ? I.none() : I.some(r ? t.slice(1) : t.slice(0, -1))
              );
            })
            .getOr(t);
        (bh(r), yh(e));
          ...
          ((e, t, n, o) => {
              ...
              us(o)
                ...
                : ((e, t, n, o, r) =>
                    su(n, e.getBody(), r).bind((e) =>
                      Eh(t, bn(e.getNode())).bind((e) =>
                        xn(e, o) ? I.none() : I.some(E),
                      ),
                    ))(e, n, t, o, r),
            );
          })(e, t, o, n).orThunk(() =>
            Mt(
              ((e, t) => {
                ...
                return (
                  Nh(t, n) || ru(t, e.getBody(), n).exists((e) => Nh(t, e))
                );
              })(e, t),
              E,
            ),
              ...
              : ((e, t, n, o) =>
                  Sh(t, o).fold(
                    () =>
                      ((e, t, n) =>
                        hh(t, n).bind((t) =>
                          t.fold(O(xh, e), O(kh, e), O(Ch, e), O(wh, e)),
                        ))(e, t, n),
                    (t) => ((e, t) => _h(e, t))(e, t),
                  ))(e, o, r, t);
          })(e, n, o);
    ...
    Yh = (e, t, n, o) => {
      ...
      return s
        ? c(1)
          ...
          : c(2)
            ? ((e, t, n, o) => (o.insertAfter(t.reverse(), e), Gh(t[0], n)))(
                s,
                a,
                d,
                t,
    ...
    Jh = (e, t, n) => {
      ...
      (m === f &&
        ...
        s.isCollapsed() ||
          ((e) => {
            ...
            ((e, t, n) =>
              !!C(n) && n === e.getParent(t.endContainer, Qh) && $u(bn(n), t))(
              t,
              n,
              o,
            )
              ...
              : n.startContainer === n.endContainer &&
                  ...
                  Yo(n.startContainer.childNodes[n.startOffset])
                ? n.deleteContents()
      ...
      const g = s.getNode(),
        ...
        h = i.parse(t, p);
      if (!0 === n.paste && qh(e.schema, h) && ((e, t) => !!Kh(e, t))(a, g))
        return ((u = Yh(d, a, s.getRng(), h)), u && s.setRng(u), t);
      (!0 === n.paste &&
        ((e, t, n, o) => {
          var r;
          ...
          if (t) {
            ...
            Dt.each(o.select("*[data-mce-fragment]"), (e) => {
              if (
                ...
                ((e, t) => ne(jg(e, t), (e) => !((e) => Ug.has(e))(e)))(o, e)
              )
                for (
    ...
    tb = (e, t) =>
      ((e, t) => {
        const n = e.dom;
        return n.parentNode
          ? ((e, t) => J(e.dom.childNodes, (e) => t(bn(e))).map(bn))(
              bn(n.parentNode),
              (n) => !xn(e, n) && t(n),
            )
          : I.none();
    ...
    ab = (e, t, n, o, r) => {
      ...
      const a = e.dom.getParent(
        t,
        (t) => !!sb(e, t, n) || t.parentNode === s || !!db(e, t, n, o, !0),
      );
      return !!db(e, a, n, o, r);
    },
    ib = (e, t, n) =>
      ...
      if (a)
        if (_e(a)) {
          for (let n = 0; n < a.length; n++)
            if (i ? e.getAttrib(t, a[n]) : im(e, t, a[n])) return !0;
        } else
          for (const o in a)
            if (ke(a, o)) {
    ...
    db = (e, t, n, o, r) => {
      ...
      if (s && zo(t))
        for (let n = 0; n < s.length; n++) {
          ...
          if (
            ib(e.dom, t, i) &&
            lb(a, t, i, "attributes", r, o) &&
            lb(a, t, i, "styles", r, o)
          ) {
            const n = i.classes;
            if (n)
              for (let r = 0; r < n.length; r++)
                if (!e.dom.hasClass(t, rm(n[r], o))) return;
            return i;
          }
        }
    },
    ...
    hb = (e, t, n = !0) => {
      const o = e.dom,
        r = e.selection;
      if (t) pb(e, t, n);
      else if (!(t = gu(e.getBody(), r.getStart())))
        for (; (t = o.get(mu)); ) pb(e, t, !1);
    },
  ...
  const _b = ["fontWeight", "fontStyle", "color", "fontSize", "fontFamily"],
      ...
      return p(n)
        ? J(
            ...
            (e) =>
              fm(e) &&
              "span" === e.inline &&
              ((e) => f(e.styles) && $(me(e.styles), (e) => H(_b, e)))(e),
          )
        : I.none();
    },
    ...
    Ab = (e, t) =>
      !1 ===
      lu(t, Ti.fromRangeEnd(e)).exists(
        (e) => !tr(e.getNode()) || lu(t, e).isSome(),
      ),
    ...
    Yb = (e, t, n) => {
      ...
      (um(n) &&
        ...
        ((n.list_block && $b(t, n.list_block)) ||
          q(ce(t.childNodes), (t) => {
            tm(e, a, t.nodeName.toLowerCase())
              ? r
                ? r.appendChild(t)
                : ((r = Kb(s, t, a)), s.setAttribs(r, El(e)))
              : (r = null);
          })),
        (((e) => mm(e) && fm(e) && Pt(xe(e, "mixed"), !0))(n) &&
          !$b(n.inline, t)) ||
          s.remove(t, !0));
    },
    Xb = (e, t, n) =>
      x(e) ? { name: t, value: null } : { name: e, value: rm(t, n) },
    Qb = (e, t) => {
      "" === e.getAttrib(t, "style") &&
    ...
    Jb = (e, t, n, o, r) => {
      ...
      (Hb(n.styles, (a, i) => {
        const { name: l, value: d } = Xb(i, a, o),
          c = am(d, l);
        ((n.remove_similar || h(d) || !zo(r) || $b(im(e, r, l), c)) &&
          e.setStyle(t, l, ""),
          (s = !0));
      }),
        s && Qb(e, t));
    ...
    Zb = (e, t, n, o, r) => {
      ...
      if (
        ...
        return (Yb(e, o, t), zb.removed());
      if (!t.ceFalseOverride && o && "false" === s.getContentEditableParent(o))
        return zb.keep();
      if (o && !ib(s, o, t) && !((e, t) => t.links && "A" === e.nodeName)(o, t))
        return zb.keep();
      const l = o,
      ...
      if ("all" !== t.remove) {
        (Jb(s, l, t, n, r),
          ...
          Hb(t.classes, (e) => {
            ((e = rm(e, n)),
              (zo(r) && !s.hasClass(r, e)) || s.removeClass(l, e));
          }));
    ...
    ev = (e, t, n, o, r) =>
      Zb(e, t, n, o, r).fold(L, (t) => (e.dom.rename(o, t), !0), M),
    tv = (e, t, n, o) =>
      Zb(e, t, n, o, o).fold(
        N(o),
      ...
      const s = e.formatter.get(t),
        ...
        u = (t) => {
          const n = ce(t.childNodes),
            o = c(t) || $(s, (e) => ib(i, t, e)),
            r = t.parentNode;
          if ((!o && C(r) && gm(a) && c(r), a.deep && n.length))
        ...
        m = (e) => {
          ...
          if (t) {
            ...
            return (
              ((e) => _u(e) && zo(e) && ("_start" === e.id || "_end" === e.id))(
                n,
    ...
    av = (e, t, n, o) => {
      const r = e.formatter.get(t),
        ...
        f = (o, a, i) => {
          ...
          (Om(o, a, (a) => {
            ...
            const p = (a) => {
              ...
              if (
                ((o) =>
                  ((e) => um(e) && !0 === e.wrapper)(s) && db(e, o, t, n))(a)
              )
                u = null;
              else {
                if (
              ...
              (!(l.length > 1) && o.isBlock(a)) || 0 !== i
                ? (fm(s) || (um(s) && s.wrapper)) &&
                  (s.exact ||
                    1 !== i ||
                    (a = ((e) => {
                      const t = J(e.childNodes, Yu).filter(
                        (e) =>
                          "false" !== o.getContentEditable(e) && ib(o, e, s),
                      );
                      return t
                        .map((t) => {
                          const n = o.clone(t, !1);
        ...
        g = Gu(o) ? o : l.getNode();
      if ("false" === i.getContentEditable(g) && !om(e, g))
        return (c(r, (o = g)), void Um(e, t, o, n));
      if (s) {
        if (o)
          if (Gu(o)) {
            if (!c(r, o)) {
  ...
  var ey = Dv([
    ...
    Cy = function (e, t) {
      if ("object" !== xv(e) || "function" != typeof e.createPolicy)
        return null;
      var n = null,
    ...
    wy = (function e() {
      var t =
          arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : yy(),
        n = function (t) {
          return e(t);
        };
      if (
      ...
      var T,
        ...
        ke = function (e) {
          (Ce && Ce === e) ||
            ...
            (ue =
              "ADD_URI_SAFE_ATTR" in e ? Qv(Jv(me), e.ADD_URI_SAFE_ATTR) : me),
            (de =
              "ADD_DATA_URI_TAGS" in e ? Qv(Jv(ce), e.ADD_DATA_URI_TAGS) : ce),
            ...
            e.FORBID_CONTENTS &&
              (ie === le && (ie = Jv(ie)), Qv(ie, e.FORBID_CONTENTS)),
            re && (z["#text"] = !0),
      ...
      var Ae = function (e) {
        ...
        Ie = function (e) {
          var t;
          if ((Me("beforeSanitizeElements", e, null), Pe(e)))
            return (Oe(e), !0);
          ...
          if (
            ...
            return (Oe(e), !0);
          if ("select" === o && Gv(/<template/i, e.innerHTML))
            return (Oe(e), !0);
          if (!z[o] || q[o]) {
            if (!q[o] && Ue(o)) {
              if (V.tagNameCheck instanceof RegExp && Gv(V.tagNameCheck, o))
                return !1;
          ...
          return e instanceof l && !Ae(e)
            ...
            : ("noscript" !== o && "noembed" !== o) ||
                !Gv(/<\/no(script|embed)/i, e.innerHTML)
              ? (X &&
                  3 === e.nodeType &&
                  ((t = e.textContent),
                  (t = qv(t, D, " ")),
                  (t = qv(t, P, " ")),
                  e.textContent !== t &&
                    (Hv(n.removed, { element: e.cloneNode() }),
                    (e.textContent = t))),
        ...
        (n.sanitize = function (e, r) {
          ...
          if (
            ...
            if ("function" != typeof e.toString)
              throw Yv("toString is not a function");
            if ("string" != typeof (e = e.toString()))
              throw Yv("dirty is not a string, aborting");
          }
          if (!n.isSupported) {
            if (
              "object" === xv(t.toStaticHTML) ||
  ...
  const By = (e, t, n, o) => {
    ...
    Py = (e, t) =>
      e.hasAttribute(Oy) && ("id" === t || "class" === t || "style" === t),
    ...
    My = (e, t, n) => {
      ...
      for (let r = o.length - 1; r >= 0; r--) {
        const s = o[r],
          a = s.name,
          i = s.value;
        Dy(t, n, e.tagName.toLowerCase(), a, i) || Py(e, a)
          ? Ly(a, n) && e.setAttribute(a, a)
          : e.removeAttribute(a);
      }
    },
    Iy = (e, t) => {
        ...
        g = (e, n) => {
          const o = m(n.attr(Oy)),
            r =
              1 === n.type &&
              !ke(e, n.name) &&
              !((e, t) => 1 === t.type && ws(e, t.name) && m(t.attr(ms)))(t, n);
          return 3 === n.type || (r && !o);
        },
        p = {
          schema: t,
              ...
              for (let t = 0, l = e.length; t < l; t++) {
                ...
                if (d && r[d.name] && l === d.lastChild) {
                  ...
                  if (l && (l.remove(), Uh(n, s, a, d))) {
                    ...
                    e &&
                      (e.removeEmpty ? d.remove() : e.paddEmpty && Ih(o, i, d));
                  }
                } else {
                  let e = l;
                  for (
    ...
    $y = (e, t) => {
      if (t.no_events) return tl.value(t);
      {
        ...
        return n.isDefaultPrevented()
          ? tl.error(Hm(e, { content: "", ...n }).content)
          : tl.value(n);
      }
    },
    Vy = (e, t, n) => {
    ...
    Zy = (e, t) => {
      ...
      for (let e = 0; e < n.length; e++) {
        const o = n[e].cells;
        for (let n = 0; n < o.length; n++)
          if (xn(o[n], t)) return I.some(Yy(n, e));
      }
      return I.none();
    },
    eC = (e, t, n, o, r) => {
    ...
    uC = (e) => {
      const t =
        ((n = e.getBody()), G(V(ce(n.childNodes), lC), (e) => e.length > 0));
      var n;
      const o = te(t, (t) => {
    ...
    yC = (e) => ({
      ...
      undoManager: {
        ...
        hasUndo: (t, n) =>
          ((e, t, n) =>
            n.get() > 0 || (t.typing && t.data[0] && !pC(uC(e), t.data[0])))(
            e,
            t,
            n,
          ),
        ...
        transact: (e, t, n) =>
          ((e, t, n) => (vC(e, t), e.beforeChange(), e.ignore(n), e.add()))(
            e,
            t,
            n,
          ),
      ...
      formatter: {
            ...
            return I.from(e.selection.getStart(!0))
              .bind((o) =>
                ob(
                  ...
                  (n) =>
                    ue(t, (t) =>
                      ((t, n) => (db(e, t.dom, n) ? I.some(n) : I.none()))(
                        n,
                        t,
                      ),
                    ),
        ...
        toggle: (t, n, o) =>
          ((e, t, n, o) => {
            const r = e.formatter.get(t);
            r &&
              (!cb(e, t, n, o) || ("toggle" in r[0] && !r[0].toggle)
                ? av(e, t, n, o)
                : nv(e, t, n, o));
          })(e, t, n, o),
        ...
        getContent: (t) =>
          ((e, t) =>
            I.from(e.getBody()).fold(
              N("tree" === t.format ? new Rg("body", 11) : ""),
              (n) => Lg(e, t, n),
            ))(e, t),
        setContent: (t, n) =>
          ((e, t, n) =>
              ...
              .map((o) =>
                Zh(t)
                  ...
                  : ((e, t, n, o) => {
                      ...
                      {
                        "raw" !== o.format &&
                          (n = Fg({ validate: !1 }, e.schema).serialize(
                            e.parser.parse(n, {
                              isRootContent: !0,
                              insert: !0,
                            }),
                        ...
                        return (
                          eb(e, r, o.no_selection),
                          { content: r, html: r }
                        );
                      }
                    })(e, o, t, n),
              )
              .getOr({ content: t, html: Zh(n.content) ? "" : n.content }))(
            e,
            t,
            n,
          ),
        ...
        (e) => (
          ...
          t.filter(qt).map((t) =>
            ((e, t, n, o) => {
              ...
              o
                ? (Ip(r, s, !1, !o), n.setStart(s, a))
                : (Ip(s, r, !1, !o), n.setEnd(s, a));
            })(e, t, n, o),
          )
        ),
      ).orThunk(() => {
        const e = ((e, t) =>
          e.filter((e) => Mm.isBookmarkNode(e.dom)).bind(t ? Tn : On))(t, o)
          .or(t)
          .filter(qt);
        return e.map((e) =>
          ((e, t) => {
            Nn(e).each((n) => {
              ...
              t && _p(n, Ti(o, 0))
                ? Lp(o, 0)
                : !t && Np(n, Ti(o, o.length)) && Mp(o, o.length);
            });
          })(e, o),
        );
      });
  ...
  const NC = (e) => !(!e || !e.ownerDocument) && kn(bn(e.ownerDocument), bn(e)),
      ...
      const { selectorChangedWithUnbind: a } = ((e, t) => {
        ...
        c = () => {
          ...
          if (C(o.bookmark) && !mg(o)) {
            const e = eg(o);
            if (e.isSome())
              return e.map((e) => vg(o, [e])[0]).getOr(i.createRange());
          }
          try {
            const e = d();
            e &&
          ...
          if (
            (n || (n = i.createRange()), Zo(n.startContainer) && n.collapsed)
          ) {
            const t = e.getRoot();
        ...
        u = (e, t) => {
          if (!((e) => !!e && NC(e.startContainer) && NC(e.endContainer))(e))
            return;
          const n = d();
          if (
        ...
        f = {
          ...
          setCursorLocation: (t, n) => {
            ...
            C(t) && C(n)
              ...
              : (Vu(e, r, o.getBody(), !0), u(r));
          },
          getContent: (e) =>
            ((e, t = {}) =>
              ((e, t, n) => xC(e).selection.getContent(t, n))(
                e,
          ...
          getBoundingClientRect: () => {
            const e = c();
            return e.collapsed
              ? Ti.fromRangeStart(e).getClientRects()[0]
    ...
    BC = (e, t, n = {}) => {
      ...
      return qy(e, o)
        .map((t) => {
          const n = ((e, t, n) => wC(e).editor.setContent(t, n))(
            e,
            t.content,
            t,
          );
                    ...
                    return C(s)
                      ...
                      : ((o = t),
                        He(o, "blob:")
                          ...
                          bv(t).then((o) =>
                            yv(o, !1, (n) => I.some(Cv(e, t, n))).getOrThunk(n),
                          ),
                        );
                  }
                  var o, r;
                  return He(t, "data:")
                    ? wv(e, t).fold(n, (e) => Promise.resolve(e))
  ...
  const fw = (e, t) => {
                      ...
                      n.status && Bl(e)
                        ...
                        : n.error &&
                          ...
                          ((e, t) => {
                            sw(
                              e,
                              Da.translate(["Failed to upload image: {0}", t]),
                            );
                          })(e, n.error.message)),
                      {
                        element: l,
    ...
    Ew = (e, t) => {
      const n = (t && t.schema) || aa({}),
        o = (e) => {
          ...
          return (
            ((e, t) => {
              (t.classes.length > 0 && xw.addClass(e, t.classes.join(" ")),
                xw.setAttribs(e, t.attrs));
            })(n, t),
            n
          );
        },
    ...
    _w = (e, t) => {
      ...
      var d;
      l.length > 0
        ? (l[0].name || (l[0].name = i), (i = t.selector), (a = Ew(l, e)))
        : (a = Ew([i], e));
    ...
    Nw = (e) => {
      ...
      return (
          ...
          e.on("mouseup keydown", (t) => {
            ((e, t) => {
              ...
              (hb(e, null, !1),
                (8 !== t && 46 !== t) ||
                  !n.isCollapsed() ||
                  n.getStart().innerHTML !== ub ||
                  hb(e, gu(o, n.getStart())),
          ...
          })(n, e),
        {
          ...
          match: (t, n, o, r) =>
            ((e, t, n, o, r) => xC(e).formatter.match(t, n, o, r))(
              e,
              t,
              n,
              o,
          ...
          matchAll: (t, n) =>
            ((e, t, n) => xC(e).formatter.matchAll(t, n))(e, t, n),
          matchNode: (t, n, o, r) =>
            ((e, t, n, o, r) => xC(e).formatter.matchNode(t, n, o, r))(
              e,
              t,
              n,
              o,
          ...
          formatChanged: (t, o, r, s) =>
            ((e, t, n, o, r, s) =>
              xC(e).formatter.formatChanged(t, n, o, r, s))(e, n, t, o, r, s),
          getCssText: O(_w, e),
        }
      );
    },
    ...
    Aw = (e) => {
      const t = Ma(),
        ...
        r = {
          ...
          add: (s, a) =>
            ((e, t, n, o, r, s, a) => xC(e).undoManager.add(t, n, o, r, s, a))(
              e,
              r,
              o,
              n,
          ...
          undo: () =>
            ((e, t, n, o) => xC(e).undoManager.undo(t, n, o))(e, r, n, o),
          ...
          hasUndo: () =>
            ((e, t, n) => xC(e).undoManager.hasUndo(t, n))(e, r, o),
          hasRedo: () =>
            ((e, t, n) => xC(e).undoManager.hasRedo(t, n))(e, r, o),
          transact: (t) =>
            ((e, t, n, o) => xC(e).undoManager.transact(t, n, o))(e, r, n, t),
          ignore: (t) => {
            ((e, t, n) => {
            ...
            (e.on("init", () => {
              ...
              e.on("keydown", (e) => {
                ...
                !(s < 16 || s > 20) ||
                  ...
                  t.typing ||
                  a ||
                  (t.beforeChange(), bC(t, !0, n), t.add({}, e), o.set(!0));
              }),
              e.on("mousedown", (e) => {
                t.typing && r(e);
              }),
            ...
            ? ((e, t, n) => {
                ...
                return Lt(o, r, Pw).filter(
                  (t) =>
                    ...
                    ((e) =>
                      !1 === rr(e.from.block.dom) && !1 === rr(e.to.block.dom))(
                      t,
                    ) &&
                    ((e) => {
    ...
    Ww = (e) => {
      ...
      return ((e, t) => {
        ...
        return (
          !((e, t) => qw(e, t.startContainer) || qw(e, t.endContainer))(e, t) &&
          n &&
          o
        );
        ...
        : ((e, t) => {
            const n = t.getRng();
            return Lt(
              th(e, bn(n.startContainer)),
              th(e, bn(n.endContainer)),
              (o, r) =>
                xn(o, r)
                  ? I.none()
                  : I.some(() => {
    ...
    nx = (e) => {
      ...
      return (
        !t.collapsed &&
        (tx(e, !0).exists((e) => e.isEqual(Ti.fromRangeStart(t))) ||
          tx(e, !1).exists((e) => e.isEqual(Ti.fromRangeEnd(t))))
      );
    },
    ox = nl([
      { remove: ["element"] },
            ...
            : (t && rr(o.getNode())) || (!t && rr(o.getNode(!0)))
              ? ((e, t, n, o) => {
                  ...
                  return th(bn(e), bn(n.getNode()))
                    .map((e) =>
                      us(e) ? ox.remove(e.dom) : ox.moveToElement(r),
                    )
                      ...
                      : ((e, t, n) =>
                          ((e, t) => {
                            const n = t.getNode(!e),
                              o = e ? "after" : "before";
                            return (
                              zo(n) && n.getAttribute("data-mce-caret") === o
                            );
                          })(t, n)
                            ? ((e, t) =>
                                y(t)
                                  ...
                                  : e && rr(t.nextSibling)
                                    ...
                                    : !e && rr(t.previousSibling)
                                      ? I.some(
                                          ox.moveToElement(t.previousSibling),
                                        )
                  ...
                  .fold(
                    () =>
                      I.some(() => {
                        var n;
                        ((n = bn(e.getBody())),
                          q(Lo(n, ".mce-offscreen-selection"), yo),
                          qp(e, t, bn(e.selection.getNode())),
                          nh(e));
                      }),
                    () => I.some(E),
                  )
    ...
    gx = (e, t) =>
      e
        ? ((e) => {
            var t;
            if (cx(e.previousSibling))
              return (
                mx(e.previousSibling) || e.previousSibling.appendData(Tr),
                e.previousSibling
              );
        ...
        : ((e) => {
            ...
            if (cx(e.nextSibling))
              return (
                ux(e.nextSibling) || e.nextSibling.insertData(0, Tr),
                e.nextSibling
              );
    ...
    hx = O(gx, !1),
    bx = (e, t) =>
      Yo(e.container()) ? gx(t, e.container()) : gx(t, e.getNode()),
    vx = (e, t) => {
      const n = t.get();
    ...
    _x = (e, t, n) => {
      const o = Qp(n);
      return Sx(e, t, o).bind((e) =>
        du(e, o).isNone() ? I.some(wx.start(e)) : I.none(),
      );
    },
    Nx = (e, t, n) => {
      const o = Xp(n);
      return Sx(e, t, o).bind((e) =>
        lu(e, o).isNone() ? I.some(wx.end(e)) : I.none(),
      );
    },
    Rx = (e, t, n) => {
      const o = Qp(n),
    ...
    Ax = (e) => {
      return (
        (t = Tx(e)),
        !(
          "rtl" === _a.DOM.getStyle(t, "direction", !0) ||
          ((e) => Wp.test(e))(
    ...
    Fx = (e, t, n) => {
      const o = e ? 1 : -1;
      return (
        t.setRng(Ti(n.container(), n.offset() + o).toRange()),
  ...
  const ak = (e, t, n, o, r, s) => {
    ...
    pk = (e, t, n, o, r, s) => {
      ...
      if (((g = o(a) ? a.getNode() : r(a) ? a.getNode(!0) : ci(n)), g)) {
        const n = ((e, t, n, o) => {
          ...
          let c = 0;
          1 === e
            ? ((s = r.next), (a = li), (i = ii), (l = Ti.after(o)))
            : ((s = r.prev), (a = ii), (i = li), (l = Ti.before(o)));
          const u = dk(l);
          do {
      ...
      return (
        e.on("NodeChange", (o) => {
          sd(e) &&
            (((e, t, n) => {
              const o = V(
                  Lo(bn(t.getRoot()), '*[data-mce-selected="inline-boundary"]'),
                  (e) => e.dom,
                ),
                r = G(o, e),
                s = G(n, e);
    ...
    Ak = (e, t, n, o) => {
      ...
      (e.undoManager.ignore(() => {
        (e.selection.setRng(
          ...
          Zp(e),
          Ox(s, r, Ti.fromRangeStart(e.selection.getRng()))
            .map(Px)
            .bind(Rk(e, t))
            .each(P));
      }),
      ...
      if (e.selection.isCollapsed() && sd(e)) {
        ...
        return ((e, t, n, o) => {
          ...
          return a
            .bind((e) =>
              n
                ? e.fold(N(I.some(Px(e))), I.none, N(I.some(Dx(e))), I.none)
                : e.fold(I.none, N(I.some(Dx(e))), I.none, N(I.some(Px(e)))),
            )
            .map(Rk(e, t))
            .getOrThunk(() => {
              const i = su(n, r, o),
        ...
        return ((e, t, n) =>
          Lt(cu(n), uu(n), (o, r) => {
            ...
            return e
              ...
              : du(n, i).exists((e) => e.isEqual(s) && t.isEqual(a));
    ...
    zk = (e) => (
      ((e) => {
        ...
        return (
          t.collapsed &&
          (Mk(t) || e.dom.isEmpty(t.startContainer)) &&
          !((e) => Uk(bn(e.selection.getStart())))(e)
        );
      })(e) && Lk(e, []),
      !0
    ),
    ...
    Kk = (e) =>
      G(
        ...
        (e) =>
          !Wk(e) &&
          !((e) => Nn(e).exists(Wk))(e) &&
          Xn(e, (e) => or(e.dom) || rr(e.dom)).exists((e) => or(e.dom)),
      ),
    Gk = (e, t) => {
      var n, o;
      const { dom: r } = e,
    ...
    Qk = (e, t, n) =>
      ue([Xk, lx, ex, (e, n) => Ok(e, t, n), Vw, Ah, dx, Hk, Kw, Fk], (t) =>
        t(e, n),
    ...
    tE = (e, t) =>
      !!Yo(t) ||
      (!!zo(t) && !eE(e.getBlockElements(), t) && !_u(t) && !ks(e, t)),
    nE = (e, t) => {
      if (Yo(t)) {
        if (0 === t.data.length) return !0;
        if (/^\s+$/.test(t.data) && (!t.nextSibling || eE(e, t.nextSibling)))
          return !0;
      }
      return !1;
    },
    ...
    rE = (e) => {
      ...
      if (
        ...
        ((e, t, n) => $(rp(bn(n), bn(t)), (t) => eE(e, t.dom)))(r, a, s)
      )
        return;
      const m = n.getRng(),
        {
      ...
      for (; v; )
        if ((zo(v) && ys(o, v), tE(o, v))) {
          ...
          (i || ((i = oE(e)), a.insertBefore(i, v), (d = !0)),
            (l = v),
            (v = v.nextSibling),
            i.appendChild(l));
    ...
    mE = (e, t) =>
      ((e, t) => {
        const n = t ? $c.Forwards : $c.Backwards,
          o = e.selection.getRng();
        return ((e, t, n) => gk(t, e, n, np, op, cE))(n, e, o).orThunk(
          () => (uE(e, n, o), I.none()),
        );
    ...
    bE = (e, t) => {
      ...
      return ((e, t) => {
        ...
        if (
          ((e, t, n) =>
            t
              ? ((e, t) => Gx(e, t).breakAt.isNone())(e.dom, n)
              : ((e, t) => Kx(e, t).breakAt.isNone())(e.dom, n))(n, t, o)
        ) {
    ...
    AE = (e, t, n) =>
      te(Pn(e), (e) => (Cn(e, t) ? (n(e) ? [e] : []) : AE(e, t, n))),
    OE = (e, t) => Zn(e, "table", t),
    TE = (e, t, n, o, r = M) => {
      const s = 1 === o;
    ...
    JE = (e, t, n) => {
      ...
      {
        const o = ni(XE);
        return I.from(o.backwards(e, t, QE(e), n)).map((e) =>
          YE(e.container, e.container.data.length),
        );
      }
    },
    ZE = (e, t, n) => {
    ...
    eS = (e, t, n) => {
      ...
      {
        const r = ni(XE);
        return I.from(r.forwards(e, t, QE(e), n)).bind((e) =>
          eS(e.container, t - o.length, n),
        );
      }
    },
    tS = (e, t, n, o, r) => {
          ...
          ((e, t, n, o = 0) => {
            ...
            return tS(
              ...
              if (
                ...
                return I.none();
              const s = nS(r);
              return 0 !== s.lastIndexOf(n) || rS(s, n).length < o
                ? I.none()
                : I.some({ text: rS(s, n), range: r, trigger: n });
            });
          })(e, t, n, o),
        (t) => {
          const o = e.createRng();
          ...
          e.fold(
            ...
            (e) => {
              ...
              return (
                ...
                (a = I.some),
                s.stype === dS.Value
                  ? { stype: dS.Value, svalue: a(s.svalue) }
                  : s
              );
              var s, a;
            },
    ...
    RS = (e, t, n) => {
      return (
        (o = ((e, t, n) =>
          ((e, t) =>
            e.stype === dS.Error
              ? { stype: dS.Error, serror: t(e.serror) }
  ...
  _S(
    [
      ...
      KS("initValue", N("")),
      t_,
      ((e, t) => MS(e, e, { tag: "required", process: {} }, NS(t)))(
        "commands",
        p_,
      ),
      jS(
        "launch",
        AS("type", { contextformbutton: f_, contextformtogglebutton: g_ }),
      ),
    ].concat(c_),
  );
  const h_ = (e) => {
      const t = e.ui.registry.getAll().popups,
        n = pe(t, (e) => {
          return ((t = e),
          RS("Autocompleter", a_, { trigger: t.ch, ...t })).fold((e) => {
            throw new Error(
              "Errors: \n" +
                ((e) => {
                  const t =
        ...
        a = (a) => {
          ((n) =>
            t
              .get()
              .map((t) =>
                sS(e.dom, e.selection.getRng(), t.trigger).bind((t) =>
                  lS(e, s, t, n),
                ),
              )
              .getOrThunk(() =>
                ((e, t) => {
                  const n = t(),
                    o = e.selection.getRng();
                  return ((e, t, n) => ue(n.triggers, (n) => sS(e, t, n)))(
                    e.dom,
                    o,
                    n,
                  ).bind((n) => lS(e, t, n));
    ...
    w_ = (e, t) => {
      ...
      if (/^(LI|DT|DD)$/.test(t.nodeName)) {
        ...
        e &&
          ...
          t.insertBefore(n.doc.createTextNode(cr), t.firstChild);
      }
      const r = n.createRng();
    ...
    P_ = {
      insert: (e, t) => {
        ...
        if (
          ...
          /^(LI|DT|DD)$/.test(r) && zo(s) && i.isEmpty(w))
        )
        ...
        if (Mr(w)) ((E = Vr(w)), i.isEmpty(w) && A_(w), D_(e, E), w_(e, E));
          ...
          ((E = k.insertBefore(f(), w)), w_(e, O_(w, "HR") ? E : w));
        else {
          const t = ((e) => {
            const t = e.cloneRange();
            return (
    ...
    K_ = (e, t) => (n, o) => {
      const r =
        ((e) => k_(e).fold(N(""), (e) => e.nodeName.toUpperCase()))(n) ===
        e.toUpperCase();
      return r === t;
    },
    G_ = (e) => {
    ...
    tN = (e, t, n) => {
      (t.selection.isCollapsed() ||
        ...
        (C(n) && C_(t, e.fakeEventName).isDefaultPrevented()) ||
          (e.insert(t, n), C(n) && y_(t, e.fakeEventName)));
    },
    nN = (e, t) => {
      const n = () => tN(H_, e, t),
        o = () => tN(P_, e, t),
    ...
    aN = (e, t, n) => {
      (n && !e.get()
        ? t.on("NodeChange", rN, !0)
        : !n && e.get() && t.off("NodeChange", rN),
        e.set(n));
    },
    iN = (e, t) => {
      const n = t.container(),
    ...
    mN = (e) =>
      Zd(e)
        ...
        : [],
    fN = (e) => {
      if ((e.addShortcut("Meta+P", "", "mcePrint"), b_(e), CC(e)))
        return Aa(null);
      {
        const t = Ek(e);
        return (
                ...
                o.isDefaultPrevented() ||
                  ((e, t, n) => {
                    ...
                    kE(
                      ...
                      .each((t) => {
                        (n.preventDefault(),
                          C_(e, o).isDefaultPrevented() || (t(), y_(e, o)));
                      });
                  })(e, t, o));
            }),
              e.on("keyup", (t) => {
                (t.isDefaultPrevented() ||
                  ((e, t, n) => {
                    ...
                    (r.isMacOS() &&
                      ...
                      xE(
                        [
                          { keyCode: Vm.BACKSPACE, action: wE(ix, e) },
                          { keyCode: Vm.DELETE, action: wE(ix, e) },
                          ...a,
                        ],
                        t,
                      ));
          ...
          ((e) => {
            e.on("keydown", (t) => {
              t.isDefaultPrevented() ||
                ((e, t) => {
                  kE([{ keyCode: Vm.SPACEBAR, action: wE(uN, e) }], t).each(
                    (n) => {
                      (t.preventDefault(),
                        C_(e, "insertText", {
                          data: " ",
                        }).isDefaultPrevented() ||
                          (n(), y_(e, "insertText", { data: " " })));
                    },
                  );
                })(e, t);
            });
  ...
  const pN = N("x-tinymce/html"),
    ...
    AN = (e, t, n) =>
      !!((e, t) =>
        NN(t) && $(Jd(e), (e) => $e(t.toLowerCase(), `.${e.toLowerCase()}`)))(
        e,
        t,
      ) &&
      ((e, t, n) => (
    ...
    UN = (e, t, n) => {
      (((e, t, n) => {
        ...
        (e.on("keydown", (e) => {
          ((e) =>
            (Vm.metaKeyPressed(e) && 86 === e.keyCode) ||
    ...
    HN = (e) => ({
      html: bN(e.selection.getContent({ contextual: !0 })),
            ...
            ((e, t) => {
              (Dd(e) &&
                ...
                e.on("dragover dragend", (n) => {
                  (Pd(e) && !t.get() && (n.preventDefault(), qN(e, VN(e, n))),
    ...
    nR = (e) => {
      const t = ((e, t) => {
        const n = Ti.fromRangeStart(e).getNode(),
          o = ((e, t) =>
            Xn(bn(e), (e) => ((e) => or(e.dom))(e) || br(e), ZN(t)).getOr(bn(t))
              .dom)(n, t),
          r = tR(n, o, !1),
          s = tR(n, o, !0),
  ...
  const rR = (e, t) => Math.abs(e.left - t),
    ...
    dR = (e, t, n) =>
      ((e, t, n) => {
        ...
        return ((e, t, n, o) => {
          const r = (t, s) => {
            ...
            return s
              ...
              .orThunk(() =>
                (xn(t, e) ? I.none() : Rn(t)).bind((e) => r(e, I.some(t))),
              );
          };
          return r(t, I.none());
        })(o, s, t, n);
        ...
        .map((e) =>
          ((e, t) => ({
            node: e.node,
            position: rR(e, t) < sR(e, t) ? oR.Before : oR.After,
          }))(e, t),
        ),
    cR = (e) => {
      var t, n;
    ...
    mR = (e) => (t, n) =>
      ((e, t, n) => ({ ...t, dataTransfer: null, type: e, ...n }))(e, t, uR(n)),
    fR = mR("dragstart"),
    gR = mR("drop"),
    pR = (e) =>
      ((e, t) => {
    ...
    _R = (e, t) => {
      ...
      return (r) =>
        e.on((e) => {
          ...
          if (!e.dragging && s > 10) {
            if (t.dispatch("dragstart", fR(r, e.element)).isDefaultPrevented())
              return;
            ...
            const s = r.currentTarget === t.getDoc().documentElement,
              l = ((e, t) => ({ pageX: t.pageX - e.relX, pageY: t.pageY + 5 }))(
                ...
                ((e, t) => {
                  return (
                    (n = ((e) =>
                      e.inline ? cR(e.getBody()) : { left: 0, top: 0 })(e)),
                    (o = ((e) => {
                      const t = e.getBody();
                      return e.inline
      ...
      const t = Ma(),
        ...
        r = ((e, t) => (n) => {
          if (((e) => 0 === e.button)(n)) {
            ...
            if (
              C(o) &&
              ((e, t, n) => bR(n) && n !== t && e.isEditable(n.parentElement))(
                t.dom,
                t.getBody(),
                o,
              )
                ...
                t.dispatch("drop", gR(n, s)).isDefaultPrevented() ||
                  t.undoManager.transact(() => {
                    (((e, t) => {
                      ...
                      (SR(t),
                        n && n !== e.getRoot() && e.isEmpty(n) && Ar(bn(n)));
                    })(t.dom, e.element),
          ...
          e.on(
            ...
            (t) => {
              const n = t.target,
                o = TR(e, n);
              OR(o)
                ? (t.preventDefault(), Yw(e, o).each(f))
                : l(n) && Yw(e, n).each(f);
            },
            !0,
          ),
          e.on("mousedown", (r) => {
              ...
              !((e, t, n) => {
                const o = bn(e.getBody()),
                  ...
                  s = ((e, t, n, o) => {
                    ...
                    return {
                      x: n - (e ? r.left + t.dom.clientLeft + ZC(t) : 0),
                      y: o - (e ? r.top + t.dom.clientTop + JC(t) : 0),
                    };
                  })(e.inline, r, t, n);
                return ((e, t, n) => {
                  const o = XC(e),
            ...
            OR(a)
              ...
              : dR(o, r.clientX, r.clientY).each((n) => {
                  var o;
                  (r.preventDefault(),
                    (o = d(1, n.node, n.position === oR.Before, !1)) &&
                      t.setRng(o),
                  ...
                  const t = (t) => {
                      if (!t.isDefaultPrevented()) {
                        ...
                        n &&
                          ...
                          (t.preventDefault(),
                          "drop" === t.type &&
                            sw(e, "Dropped file type is not supported"));
                      }
                    },
                    n = (n) => {
                      ag(e, n.target) && t(n);
              ...
              e.on("focusin", (t) => {
                ...
                if (ir(n)) {
                  ...
                  e.selection.getNode() !== o &&
                    Yw(e, o).each((t) => e.selection.setRng(t));
                }
              });
            });
          })(e)),
    ...
    DR = (e, t) => {
      let n = t;
      for (let t = e.previousSibling; Yo(t); t = t.previousSibling)
        n += t.data.length;
      return n;
    },
    PR = (e, t, n, o, r) => {
    ...
    jR = (e, t, n) => {
      ...
      return {
        ...
        inlinePatterns: il(o).concat(e.inlinePatterns),
      };
    },
    HR = (e, t, n, o) => {
      const r = e.createRng();
    ...
    $R = (e, t, n) => {
      ((e, t, n) => {
        ...
        {
          const t = ni(XE);
          return I.from(t.forwards(e, 0, QE(e), n)).map((e) =>
            YE(e.container, 0),
          );
        }
      })(t, 0, t).each((o) => {
    ...
    WR = (e, t, n) => {
      ...
      return {
        prefix: t,
        end: a.parentNode.insertBefore(VR(e, t + "-end"), a),
        start: l.insertBefore(VR(e, t + "-start"), i),
      };
    },
    KR = (e, t, n) => {
      (FR(e, e.get(t.prefix + "-end"), n),
        FR(e, e.get(t.prefix + "-start"), n));
    },
          ...
          });
        {
          ...
          return m.map((e) => {
            ...
            return {
              ...
              position: YE(e.startContainer, e.startOffset),
            };
          });
        }
      });
                ...
                .map((e) =>
                  Dt.trim(i).length === e.start.length
                    ...
                    : [
                        {
                          pattern: e,
                          range: LR(s, s.getRoot(), t, 0, t, 0, true),
                        },
                      ],
                )
                .getOr([]);
                  ...
                  ((e, t) => {
                    ...
                    (q(t, (t) =>
                      ((e, t) => {
                        const n = e.dom,
                          o = t.pattern,
                          r = IR(n.getRoot(), t.range).getOrDie(
                ...
                (e.execCommand("mceInsertNewLine"),
                  n.each((t) => {
                    ...
                    n.data.charAt(t.offset - 1) === dr &&
                      ...
                      FR(e.dom, n.parentNode, (t) => t === e.dom.getRoot()));
                  }));
              },
            ),
            !0)
    ...
    uA = (e) => {
      !0 !== e.removed &&
        (((e) => {
          (CC(e) || e.load({ initial: !0, format: "html" }),
    ...
    mA = (e) => {
      ...
      ((o.disabled = !0),
        ...
        e.readonly ||
          (e.inline &&
            "static" === rA.getStyle(o, "position", !0) &&
        ...
        CC(e) ||
          ...
          ((e) => {
            ((e) => {
              ...
              (e.on("keyup", (e) => {
                nA(n, e, (e, t) => e === t.keyCode && !Vm.modifierPressed(t)) &&
                  s();
              }),
                e.on("keypress", (n) => {
                  nA(t, n, (e, t) => e.charCodeAt(0) === t.charCode) &&
                    ng.setEditorTimeout(e, s);
                }));
            })(e);
          })(e)));
      const r = fN(e);
            ...
            s = (t, a) => {
              ...
              const i = e.getBody(),
                l =
                  !((e) =>
                    Bw(e) &&
                    !(Dw(e) || ("keyup" === e.type && 229 === e.keyCode)))(t) &&
                  ((e, t, n) => {
                    if (us(bn(t), !1)) {
          ...
          Ge(r) &&
            e.on("init", (t) => {
              (s(t, !0),
                ...
                e.on("paste", (t) => ng.setEditorTimeout(e, () => s(t))));
            });
        })(e),
        YN(e));
      const s = ((e) => {
      ...
      (((e) => {
        ...
        (((e) => {
          ...
          Td(e) ||
            ((t.body.spellcheck = !1), rA.setAttrib(n, "spellcheck", "false")),
          (e.quirks = oA(e)),
          ((e) => {
    ...
    vA = async (e) => {
      (e.dispatch("ScriptsLoaded"),
        ...
        ((e) => {
          ...
          if (m(t)) {
            const n = nw.get(t);
            ((e.theme = n(e, nw.urls[t]) || {}),
              w(e.theme.init) &&
                e.theme.init(
                  e,
                  nw.urls[t] || e.documentBaseUrl.replace(/\/$/, ""),
                ));
          } else e.theme = {};
        })(e),
        ((e) => {
            ...
            ((e, t, n) => {
              ...
              if (((n = Dt.trim(n)), o && -1 === Dt.inArray(t, n))) {
                ...
                try {
                  ...
                  ((e, t, n) => {
                    const o = Da.translate([
                      "Failed to initialize plugin: {0}",
                      t,
                    ]);
                    (Fm(e, "PluginLoadError", { message: o }),
                      lw(o, n),
                      sw(e, o));
                  })(e, n, t);
                }
          ...
          : ((e, t) => {
              (((e, t) => {
                ...
                t.editorContainer &&
                  ...
                  (e.hidden = gA.isHidden(t.editorContainer))),
    ...
    TA = (e, t, n, o, r) => {
      var s;
      const a = e
          ? { mobile: AA(null !== (s = r.mobile) && void 0 !== s ? s : {}, t) }
          : {},
        i = NA(["mobile"], vS(a, r)),
        l = Dt.extend(
          n,
      ...
      return ((e, t, n, o) => {
        const r = _A(n.forced_plugins),
          ...
          i = ((e, t, n, o) => (e && RA(t, "mobile") ? o : n))(
            e,
            t,
            s,
            a.plugins ? _A(a.plugins) : s,
          ),
          l = ((e, t) => [..._A(e), ..._A(t)])(r, i);
    ...
    DA = (e, t) => {
      ...
      return /^ | $/.test(t)
        ? ((e, t, n) => {
            ...
            return (
              (n = _p(o, Ti.fromRangeStart(t))
                ? n.replace(/^ /, "&nbsp;")
                : n.replace(/^&nbsp;/, " ")),
              Np(o, Ti.fromRangeEnd(t))
                ? n.replace(/(&nbsp;| )(<br( \/)>)?$/, "&nbsp;")
                : n.replace(/&nbsp;(<br( \/)?>)?$/, " ")
            );
          })(o, n.getRng(), t)
    ...
    PA = (e, t) => {
      if (e.selection.isEditable()) {
        ...
        qy(e, {
          ...
          const n = ((e, t, n) => wC(e).editor.insertContent(t, n))(
            e,
            t.content,
            o,
          );
          ...
          ((e, t, n) =>
            ob(
              ...
              (t) =>
                ((t) =>
                  lo(t, e).orThunk(() =>
                    MA(t) ? xe(LA, e).bind((e) => Zt(t, e)) : I.none(),
                  ))(t),
              (e) => xn(bn(t), e),
            ))(e, t, n.dom).or(
            ((e, t) => I.from(_a.DOM.getStyle(t, e, !0)))(e, n.dom),
          ),
        )
        .getOr(""),
    FA = IA("font-size"),
        ...
        ((e) => {
          e.editorCommands.addCommands({
            mceSelectNodeDepth: (t, n, o) => {
              ...
              e.dom.getParent(
                e.selection.getNode(),
                (t) => !zo(t) || r++ !== o || (e.selection.select(t), !1),
                e.getBody(),
              );
            },
            mceSelectNode: (t, n, o) => {
          ...
          (((e) => {
            ...
            e.editorCommands.addCommands({
              ...
              FontName: (t, n, o) => {
                ((e, t) => {
                  const n = HA(e, t);
                  (e.formatter.toggle("fontname", { value: $A(n) }),
                    e.nodeChanged());
                })(e, o);
              },
              FontSize: (t, n, o) => {
                ((e, t) => {
                  (e.formatter.toggle("fontsize", { value: HA(e, t) }),
                    e.nodeChanged());
                })(e, o);
              },
              LineHeight: (t, n, o) => {
            ...
            ((e) => {
              ...
              (e.editorCommands.addCommands(
                ...
                e.editorCommands.addQueryValueHandler("FontName", () =>
                  ((e) => jA(e, (t) => UA(e.getBody(), t.dom)).getOr(""))(e),
                ),
                e.editorCommands.addQueryValueHandler("FontSize", () =>
                  ((e) => jA(e, (t) => FA(e.getBody(), t.dom)).getOr(""))(e),
                ),
                  ...
                  (t
                    ...
                    : ((e) => {
                        ...
                        if (r && e.dom.isChildOf(r, n))
                          return (ug(r), cg(e, o), void fg(e));
                        (e.inline ||
                          (At.browser.isOpera() || ug(n), e.getWin().focus()),
  ...
  class KA {
    ...
    queryCommandState(e) {
      if ((!WA(e) && this.editor.quirks.isHidden()) || this.editor.removed)
        return !1;
      const t = e.toLowerCase(),
  ...
  const GA = "data-mce-contenteditable",
    ...
    ZA = (e) => {
      (e.parser.addAttributeFilter("contenteditable", (t) => {
        JA(e) &&
          q(t, (e) => {
            (e.attr(GA, e.attr("contenteditable")),
    ...
    rO = {
      ...
      dispatch(e, t, n) {
        ...
        if (o.removed && "remove" !== e && "detach" !== e)
          return ca(e.toLowerCase(), null != t ? t : {}, o);
        ...
        : JA(e) &&
          ((e, t) => {
            if (((e) => "click" === e.type)(t) && !Vm.metaKeyPressed(t)) {
              const n = bn(t.target);
              ((e, t) =>
                Zn(t, "a", (t) => xn(t, bn(e.getBody()))).bind((e) =>
                  Zt(e, "href"),
                ))(e, n).each((n) => {
        ...
        "focus" !== e &&
          ...
          (n.removed ||
            (t
              ...
              : n.initialized &&
                n.delegates &&
                (n.dom.unbind(iO(n, e), e, n.delegates[e]),
        ...
        ((e) => e in CO)(e)
          ...
          : /^[0-9]{2,}$/.test(e)
            ...
            : ((t.charCode = e.charCodeAt(0)),
              (t.keyCode = yO[e] || e.toUpperCase().charCodeAt(0)));
      });
      const o = [t.keyCode];
      let r;
  ...
  class NO {
    constructor(e, t, n) {
        ...
        const n = {},
          ...
          r = (e, t, n) => {
            ...
            return fO(r)
              ? ((o[e] = r.value), !0)
              : (console.warn(
                  mO(`Invalid value passed for the ${e} option`, r),
                ),
                !1);
          },
          s = (e) => ke(n, e);
            ...
            const a = ((e) => m(e.processor))(s)
              ...
              i = ((e, t, n) => {
                if (!v(t)) {
                  ...
                  console.error(
                    mO(`Invalid default value passed for the "${e}" option`, o),
                  );
                }
              })(e, s.default, a);
      ...
      const l = zl(o);
      l &&
        (Ra.ScriptLoader._setReferrerPolicy(l),
        _a.DOM.styleSheetLoader._setReferrerPolicy(l));
      const d = yd(o);
      ...
      ((e) => {
        ...
        (e.on("remove", () => {
          ...
          (e.ui.styleSheetLoader = ((e, t) =>
            Os.forElement(e, { contentCssCors: yd(t), referrerPolicy: zl(t) }))(
            o,
            e,
          )),
          ud(e)
        ...
        (s &&
          ...
          md(e) &&
            !Go(e.getElement()) &&
            (yA.insertAfter(yA.create("input", { type: "hidden", name: t }), t),
            (e.hasHiddenInput = !0)),
    ...
    show() {
      ...
      e.hidden &&
        ...
        e.inline
          ...
          : (EO.show(e.getContainer()), EO.hide(e.id)),
        e.load(),
        e.dispatch("show"));
    }
    hide() {
      ...
      e.hidden ||
        ...
        e.inline
          ...
          : (EO.hide(e.getContainer()),
            EO.setStyle(e.id, "display", e.orgDisplay)),
        (e.hidden = !0),
        e.dispatch("hide"));
    }
    isHidden() {
    ...
    resetContent(e) {
      (void 0 === e
        ? BC(this, this.startContent, { format: "raw" })
        : BC(this, e),
    ...
    getContainer() {
      ...
      return (
        e.container ||
          (e.container = e.editorContainer || EO.get(e.id + "_parent")),
        e.container
      );
    }
    ...
    getElement() {
      return (
        this.targetElm || (this.targetElm = EO.get(this.id)),
        this.targetElm
      );
    }
    getWin() {
  ...
  const DO = (e) => {
    ...
    PO = (e) => {
      if (e !== TO) {
        const t = _a.DOM;
        (e
          ? (t.bind(window, "resize", DO), t.bind(window, "scroll", DO))
          : (t.unbind(window, "resize", DO), t.unbind(window, "scroll", DO)),
          (TO = e));
      }
    },
    LO = (e) => {
      ...
      return (
        (BO = G(BO, (t) => e !== t)),
        IO.activeEditor === e &&
          (IO.activeEditor = BO.length > 0 ? BO[0] : null),
    ...
    IO = {
            ...
            return (
              ...
              h(t.get(n.id))
                ...
                : (LO(n) && t.dispatch("RemoveEditor", { editor: n }),
                  0 === BO.length &&
                    window.removeEventListener("beforeunload", OO),
                  n.remove(),
                  PO(BO.length > 0),
                  n)
            );
      ...
      _setBaseUrl(e) {
        ((this.baseURL = new Ry(this.documentBaseURL).toAbsolute(
          e.replace(/\/+$/, ""),
        )),
          (this.baseURI = new Ry(this.baseURL)));
      },
    };
  IO.setup();
  const FO = (() => {
